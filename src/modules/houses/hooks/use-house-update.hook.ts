...
type Params = Parameters<typeof houseKeys.update>[0];
type Success = Awaited<ReturnType<typeof houseRepositories.update>>;
 ...
 */
export function useHouseUpdate(
  params?: Params,
  ...
  return useMutation<Success, Error, Exclude<Params, undefined>>({
    mutationKey: houseKeys.update(params),
    mutationFn: (params) => houseRepositories.update(params),
