...
import { Button } from '@shared/components/plate-ui/button';
import {
  Command,
  CommandEmpty,
  CommandGroup,
  ...
  CommandItem,
  CommandList,
} from '@shared/components/plate-ui/command';
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogTitle,
  DialogTrigger,
} from '@shared/components/plate-ui/dialog';
import { Input } from '@shared/components/plate-ui/input';
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from '@shared/components/plate-ui/popover';
