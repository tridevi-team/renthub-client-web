...
import { Dialog, DialogContent } from '@shared/components/selectbox/dialog';
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center rounded-lg" cmdk-input-wrapper="">
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group
    ref={ref}
    className={cn(
      'overflow-hidden p-1 text-slate-950 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-slate-500 [&_[cmdk-group-heading]]:text-xs',
      className,
    )}
    {...props}
  />
...
const CommandShortcut = ({
  ...
  return (
    <span
      className={cn(
        'ml-auto text-slate-500 text-xs tracking-widest',
        className,
      )}
      {...props}
    />
