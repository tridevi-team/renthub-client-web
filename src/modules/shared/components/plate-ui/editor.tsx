...
export const EditorContainer = ({
  ...
  return (
    <div
      ...
      ref={containerRef}
      className={cn(
        'ignore-click-outside/toolbar rounded-md border ring-offset-background',
  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        ...
        demo: 'size-full px-10 pb-52 pt-4 text-base sm:px-[max(64px,calc(50%-350px))]',
        fullWidth: 'size-full px-16 pb-32 pt-4 text-base sm:px-24',
        none: '',
      },
    },
  },
