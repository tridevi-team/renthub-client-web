...
export function AriaSwitch({ children, className, ...props }: MySwitchProps) {
  return (
    <Switch
      ...
      {...props}
    >
      <div className="h-5.5 box-border flex w-10 shrink-0 cursor-default rounded-full border border-solid border-primary bg-white bg-clip-padding px-1 py-1.5 shadow-inner outline-none ring-black transition duration-200 ease-in-out group-rac-focus-visible:ring group-rac- group-rac-pressed:bg-primary-content group-rac-selected:bg-primary">
